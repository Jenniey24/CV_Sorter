// Dial code -> country name. Ordered so longer/more specific codes
// can be matched before shorter overlapping prefixes (e.g. +234 before +23).
const DIAL_CODES = [
  ["247","Ascension Island"],["262","Reunion/Mayotte"],["290","Saint Helena"],["350","Gibraltar"],
  ...
  ["599","Curacao"],["670","Timor-Leste"],["672","Norfolk Island"],["673","Brunei"],["674","Nauru"],
  ["675","Papua New Guinea"],["676","Tonga"],["677","Solomon Islands"],["678","Vanuatu"],["679","Fiji"],
  ["680","Palau"],["681","Wallis and Futuna"],["682","Cook Islands"],["683","Niue"],["685","Samoa"],
  ...
  ["243","Democratic Republic of the Congo"],["244","Angola"],["245","Guinea-Bissau"],["248","Seychelles"],
  ...
  ["266","Lesotho"],["267","Botswana"],["268","Eswatini"],["269","Comoros"],["27","South Africa"],
  ...
  ["1","United States/Canada"],["20","Egypt"],["7","Russia/Kazakhstan"],
];

// Country names for plain-text scanning (address / nationality lines).
const COUNTRY_NAMES = [
  "Nigeria","Ghana","Kenya","South Africa","Egypt","Morocco","Algeria","Tunisia","Ethiopia",
  "Uganda","Tanzania","Rwanda","Senegal","Ivory Coast","Cote d'Ivoire","Cameroon","Zambia",
  "Zimbabwe","Namibia","Botswana","Mozambique","Angola","Sudan","South Sudan","Libya","Somalia",
  "Benin","Togo","Sierra Leone","Liberia","Mali","Niger","Burkina Faso","Gabon","Congo",
  "United Kingdom","England","Ireland","Scotland","Wales","United States","USA","United States of America",
  "Canada","Australia","New Zealand","Germany","France","Spain","Portugal","Italy","Netherlands",
  "Belgium","Switzerland","Austria","Sweden","Norway","Denmark","Finland","Poland","Czech Republic",
  "Hungary","Romania","Greece","Turkey","Russia","Ukraine","India","Pakistan","Bangladesh",
  "China","Japan","South Korea","Philippines","Malaysia","Singapore","Indonesia","Thailand",
